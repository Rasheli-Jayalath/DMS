...
?>
<td width="2%" colspan="3">Action </td>
 </tr>
			...
			if($total_numdd>=1)
			{
			 ...
			 <?php if($category_status==1){ ?>
			  <td><?php
					...
					?>
<td><a href="javascript:void(null);" onclick="window.open('send_file.php?report_id=<?php echo $rows['report_id']; ?>', 'Email','width=550,height=400,scrollbars=yes');" ><img  src="./images/send_mail.png" title="Send Email"/></a></td>
<?php	
			 if($user_type==1)
			 {
			 ?>
