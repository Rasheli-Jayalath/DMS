				...
				if (strpos($cddata3['user_ids'], $u_id) !== false) 
							...
							$len=count($arr_ids);
								...
								$len_rite=count($arr_rite);
									if($len_rite==1)
									{
											if(($arr_rite[0]==$u_id."_1") || ($arr_rite[0]==$u_id."_2"))
											{
											$user_rt=$arr_rite[0];
									...
									for($j=0; $j<$len_rite; $j++)
											{
													if(($arr_rite[$j]==$u_id."_1") || ($arr_rite[$j]==$u_id."_2"))
													{
...
<table border="1px solid" width="100%" >
		...
		if ((strpos($cddatat['user_right'], $abc."_1") !== false) || (strpos($cddatat['user_right'], $abc."_2") !== false))
		{
				$arr_ritu=explode(",",$cddatat['user_right']);
				$len_ritu=count($arr_ritu);
				for($r=0; $r<$len_ritu; $r++)
					{
						if(($arr_ritu[$r]==$abc."_1")||($arr_ritu[$r]==$abc."_2"))
								{
									//$active="active";
									$flag3="active";
		...
		<td width="30%">
		<div class="<?php echo $active; ?>"  >
  <input type="radio" name="status<?php echo $category_cd2;?>" value="2" <?php if($user_rit=="2"){ echo "checked";} ?> <?php /*if($user_rit=="1"){ */?> onclick="Showactive(<?php echo $category_cd2;?>,2,<?php echo $items; ?>,<?php echo $abc; ?>)" <?php //}?> >R
  <input type="radio" name="status<?php echo $category_cd2;?>" value="1" <?php if($user_rit=="1"){ echo "checked";} ?> <?php /*if($user_rit=="0"){*/ ?>onclick="Showactive(<?php echo $category_cd2;?>,1,<?php echo $items; ?>,<?php echo $abc; ?>)"<?php //}?>>R/W
